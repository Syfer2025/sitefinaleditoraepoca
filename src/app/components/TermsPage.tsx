        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-xs text-[#856C42]" style={{ fontFamily: F }}>Última atualização: 03 de março de 2026</p>
            </div>
          </div>

          <div className="prose prose-sm max-w-none text-[#052413]/80 leading-relaxed space-y-6" style={{ fontFamily: F }}>
            <section>
              <h2 className="text-lg font-semibold text-[#052413] mt-8 mb-3" style={{ fontFamily: PF }}>1. Aceitação dos Termos</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#052413] mt-8 mb-3" style={{ fontFamily: PF }}>2. Descrição dos Serviços</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#052413] mt-8 mb-3" style={{ fontFamily: PF }}>3. Cadastro e Conta do Usuário</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#052413] mt-8 mb-3" style={{ fontFamily: PF }}>4. Contratação e Pagamento</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#052413] mt-8 mb-3" style={{ fontFamily: PF }}>6. Responsabilidades do Usuário</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#052413] mt-8 mb-3" style={{ fontFamily: PF }}>7. Limitação de Responsabilidade</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#052413] mt-8 mb-3" style={{ fontFamily: PF }}>8. Proteção de Dados</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#052413] mt-8 mb-3" style={{ fontFamily: PF }}>9. Modificações nos Termos</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#052413] mt-8 mb-3" style={{ fontFamily: PF }}>11. Legislação Aplicável</h2>
              <p>
